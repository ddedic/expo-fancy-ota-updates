...
export function OverviewScreen() {
  ...
  return (
      ...
      header={
        ...
        >
          ...
          <Text
            ...
            selectable
          >
            Show exactly how update banners feel for real users.
          </Text>

          <Text style={{ color: palette.textMuted, fontSize: 14, lineHeight: 20, fontWeight: '500' }} selectable>
            Use this tab to trigger banner states without needing backend setup or release engineering context.
          </Text>
    ...
    >
      <SectionCard
        palette={palette}
        title="Try banner states"
        subtitle="Simple controls to preview the complete user-facing banner journey."
      >
      ...
      <SectionCard
        palette={palette}
        title="Current banner state"
        subtitle="Useful context while validating copy and behavior with non-technical stakeholders."
      >
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
