...
Want to preview the UI/runtime side while reading CLI docs? Run the [Expo Showcase Demo](https://ddedic.github.io/expo-fancy-ota-updates/apps/expo-showcase) from `apps/expo-showcase`.
