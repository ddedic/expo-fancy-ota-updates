...
- **[Expo Showcase Demo](https://ddedic.github.io/expo-fancy-ota-updates/apps/expo-showcase)** — Full interactive Expo app preview
...
```bash
pnpm install
pnpm --filter expo-fancy-ota-showcase start
```
...
**📖 Demo Docs:** [Expo Showcase Demo](https://ddedic.github.io/expo-fancy-ota-updates/apps/expo-showcase)
