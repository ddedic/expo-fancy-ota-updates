...
features:
  ...
  - icon: 📡
    ...
    details: Switch update channels at runtime — let QA/stakeholders preview staging updates without rebuilding.

  - icon: 🧪
    title: Live Expo Demo
    details: Run the full interactive app from /examples/demo to preview behavior before integration.
---

<div style="text-align: center; margin: 3rem 0; padding: 2rem 2rem 1.75rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 16px;">
  <a href="https://www.photo-trim.com" target="_blank" style="display: inline-block;">
    <img src="/logo.png?url" alt="Photo Trim" style="width: 72px; height: 72px; border-radius: 16px;" />
  </a>
  <h3 style="color: white; margin: 0.75rem 0 0.25rem; border: none; padding: 0;">
...
<div class="tip custom-block">
  <p class="custom-block-title">Built for production</p>
  <p>Battle-tested in shipping iOS apps — not a weekend experiment.</p>
</div>
